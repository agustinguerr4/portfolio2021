      ...
      >
        <template v-if="!template">
          ...
          <a
            ...
            v-ripple
          >
            <span class="mani-icons" v-if="item.icon == 'linkedin'">
              <linkedin></linkedin
            ></span>
            <span class="mani-icons" v-else-if="item.icon == 'github'">
              <github></github
            ></span>
            <span class="mani-icons" v-else-if="item.icon == 'gitlab'">
              <gitlab></gitlab
            ></span>
            <span class="mani-icons" v-else-if="item.icon == 'vue'">
              <vuejs></vuejs
            ></span>
            <span class="mani-icons" v-else-if="item.icon == 'code'">
              <code-tags></code-tags
            ></span>
            <span class="mani-icons" v-else-if="item.icon == 'education'">
              <book-education></book-education
            ></span>
            <span class="mani-icons" v-else-if="item.icon == 'user'">
              <account></account
            ></span>
            <span class="mani-icons" v-else-if="item.icon == 'wordpress'">
              <wordpress></wordpress
            ></span>
            <span class="mani-icons" v-else-if="item.icon == 'react'">
              <react></react
            ></span>
            <span
              class="mani-icons"
            ...
            ></span>
            <span class="mani-icons" v-else-if="item.icon == 'web'">
              <web></web
            ></span>
            <span class="mani-icons" v-else-if="item.icon == 'email'">
              <email></email
            ></span>


              <country-flag style="zoom:80%" v-else-if="item.icon == 'lang-es'" country='ar' size='normal'/>
              <country-flag style="zoom:80%" v-else-if="item.icon == 'lang-en'" country='gb' size='normal'/>



            <span v-else :class="['p-menuitem-icon', item.icon]"></span>
            <span class="p-menuitem-text">{{ item.label }}</span>
